...
#include <set>
#include <stdexcept>
#include <GLFW/glfw3.h> // Required for getRequiredExtensions
...
// --- VulkanDevice Class Implementation ---
...
void VulkanDevice::createSurface() { window_.createWindowSurface(instance_, &surface_); }
...
// Helper function to find memory types
